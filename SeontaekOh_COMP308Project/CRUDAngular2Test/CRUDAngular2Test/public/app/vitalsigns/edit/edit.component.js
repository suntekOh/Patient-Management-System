            ...
            EditComponent = (function () {
                ...
                EditComponent.prototype.ngOnInit = function () {
                    ...
                    this.paramsObserver = this._route.params.subscribe(function (params) {
                        var articleId = params['vitalsignsId'];
                        _this._articlesService.read(articleId).subscribe(function (article) {
                            _this.article = article;
                            _this.article.measuredDate = new Date(_this.article.measuredDate).toISOString().split('T')[0];
                ...
                EditComponent.prototype.update = function () {
                    var _this = this;
                    this._articlesService.update(this.article).subscribe(function (savedArticle) { return _this._router.navigate(['/vitalsigns', savedArticle._id]); }, function (error) { return _this.errorMessage =
                        error; });
                };
