System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./dailytips.routes", "./dailytips.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component"], function (exports_1, context_1) {
    ...
    var core_1, common_1, forms_1, router_1, dailytips_routes_1, dailytips_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, DailyTipsModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            DailyTipsModule = __decorate([
                core_1.NgModule({
                    imports: [
                        ...
                        forms_1.FormsModule,
                        router_1.RouterModule.forChild(dailytips_routes_1.DailyTipsRoutes),
                    ],
                    declarations: [
...
//# sourceMappingURL=dailytips.module.js.map