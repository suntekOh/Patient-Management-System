System.register(["./dailytips.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component"], function (exports_1, context_1) {
    ...
    var dailytips_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, DailyTipsRoutes;
    return {
        setters: [
        ...
        execute: function () {
            exports_1("DailyTipsRoutes", DailyTipsRoutes = [{
                    path: 'dailytips',
                    component: dailytips_component_1.DailyTipsComponent,
                    children: [
                        { path: '', component: list_component_1.ListComponent },
                        { path: 'create', component: create_component_1.CreateComponent },
                        { path: ':dailytipsId', component: view_component_1.ViewComponent },
                        { path: ':dailytipsId/edit', component: edit_component_1.EditComponent }
                    ],
                }]);
        }
    };
