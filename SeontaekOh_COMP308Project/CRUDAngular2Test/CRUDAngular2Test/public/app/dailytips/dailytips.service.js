System.register(["rxjs/Rx", "rxjs/Observable", "@angular/core", "@angular/http"], function (exports_1, context_1) {
    ...
    var Observable_1, core_1, http_1, DailyTipsService;
    return {
        setters: [
            function (_1) {
            },
        ...
        execute: function () {
            DailyTipsService = (function () {
                ...
                DailyTipsService.prototype.create = function (article) {
                    return this._http
                ...
                DailyTipsService.prototype.read = function (vitalsignsId) {
                    return this._http
                        .get(this._baseURL + "/" + vitalsignsId)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                DailyTipsService.prototype.update = function (article) {
                    return this._http
                        .put(this._baseURL + "/" + article._id, article).map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                DailyTipsService.prototype.delete = function (articleId) {
                    return this._http
                        .delete(this._baseURL + "/" + articleId)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                DailyTipsService.prototype.list4patients = function () {
                    return this._http
