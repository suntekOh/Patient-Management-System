System.register(["@angular/core", "@angular/router", "../dailytips.service"], function (exports_1, context_1) {
    ...
    var core_1, router_1, dailytips_service_1, EditComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            EditComponent = (function () {
                ...
                EditComponent.prototype.ngOnInit = function () {
                    ...
                    this.paramsObserver = this._route.params.subscribe(function (params) {
                        var articleId = params['dailytipsId'];
                ...
                EditComponent.prototype.update = function () {
                    var _this = this;
                    this._articlesService.update(this.article).subscribe(function (savedArticle) { return _this._router.navigate(['/dailytips', savedArticle._id]); }, function (error) { return _this.errorMessage =
                        error; });
                };
